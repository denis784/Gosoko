...
class ProductOrderSerializer(serializers.ModelSerializer):
    ...
    business_registration_number=serializers.SerializerMethodField()
    ...
    def get_business_email(self, instance):
        return instance.business_email
    def get_business_registration_number(self, instance):
        return instance.business_registration_number
